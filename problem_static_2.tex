...
Під останньою розуміємо функції, що задовольняють крайові задачі
...
\end{pmatrix}$ та $\Psi_i(y) = \begin{pmatrix}
    ...
    \psi_i^3(y) & \psi_i^4(y)
\end{pmatrix}$, $i=0,1$.
\newline З урахуванням цих позначень, шукані функціі перемішень у просторі трансформант зображено у наступному вигляді
...
Для того, щоби знайти її потрібно задовольнити граничну умову $\sigma_y(x, y) |_{y=b} = -p(x)$,
