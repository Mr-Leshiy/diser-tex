...
\begin{align*}
    ...
    &= \frac{\partial v(x,y)}{\partial x}|_{x=a} cos(\alpha_n a) -\alpha_n^2 v_n(y)
\end{align*}
...
\begin{align*}
    &(1 + \mu_0) v_n^{''}(y) + \alpha_n \mu_0 u_n^{'}(y)  - (\alpha_n^2 -  \frac{\omega^2}{c_2^2}) v_n(y) = -\frac{\partial v(x,y)}{\partial x}|_{x=a} cos(\alpha_n a)
\end{align*}
...
\subsubsection{Зведення задачі у просторі трансформант до матрично-векторної форми}
...
\subsubsection{Побудова матриці-функції Гріна}
...
\subsubsection{Розв'язок сінгулярного інтегрального рівняння}
