...
Для того, щоб звести задачу до одновимірної задачі, використаєм інтегральне перетворення Фур'є по змінній $x$ у до рівнянь (\ref{lame_gen}) наступному вигляді:
\begin{equation}
    \begin{pmatrix}
        u_n(y) \\
        v_n(y)
...
Рівняння рівноваги (\ref{transf_gen}) запишемо у наступному вигляді:
...
\begin{equation*}
    ...
    \end{pmatrix}
\end{equation*}
Граничні умови (\ref{transf_bound_gen}) запишемо у наступному вигляді:
...
Для знаходження розв'язку задачі у просторі трансформант, знайдем фундаментальну матрицю рівняння (\ref{transf_mat_gen}).
