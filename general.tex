...
Для знаходження розв'язку задачі потрібно відшукати фундаментальну матрицю рівняння \eqref{transf_mat_gen}.
% Посмотреть как у Зіни єтот кусок (раздел 2.2 - 2.3)
...
\end{equation}
Тут матриці $Y_i(y)$, $i=\overline{0, 3}$ визначено формулами (??), де $C_1^j$, $C_2^j$, $j=\overline{0, 1}$ невідомі матриці коєфіцієнтів, які знайдено з граничних умов \eqref{psi_probl_gen}
