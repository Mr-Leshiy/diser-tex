...
\section[МІШАНА ЗАДАЧА ДЛЯ ПРЯМОКУТНОЇ ОБЛАСТІ ЗА УМОВ ДРУГОЇ ОСНОВНОЇ ЗАДАЧІ НА БІЧНИХ ГРАНЯХ]
{\centering МІШАНА ЗАДАЧА ДЛЯ ПРЯМОКУТНОЇ ОБЛАСТІ ЗА УМОВ ДРУГОЇ ОСНОВНОЇ ЗАДАЧІ НА БІЧНИХ ГРАНЯХ}
...
\section*{\centering Додаток A}\label{ap_A}
\input{apendix_a}
