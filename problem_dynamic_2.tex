...
\begin{align}\label{transf_sol_u_dynamic_2}
    &u_n(y) = (-1)^n (1+\mu_0) \int_0^b g_1(y, \xi)f(\xi) cos(\alpha_n a) d\xi - \psi_0^2(y) p_n
\end{align}
\begin{align}\label{transf_sol_v_dynamic_2}
    &v_n(y) = (-1)^n (1+\mu_0) \int_0^b g_3(y, \xi)f(\xi) cos(\alpha_n a) d\xi - \psi_0^4(y) p_n
\end{align}
...
\end{equation}
\begin{equation}
    v(x,y) = \frac{2}{a} \sum_{n=1}^{\infty} v_n(y) cos(\alpha_n x), \quad \alpha_n = \frac{\pi n}{a}
\end{equation}
